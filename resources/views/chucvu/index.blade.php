...
<section class="content-header" style="background-color:#dcedc8">
      <div class="container-fluid">
        <div class="row mb-2">
          ...
          <div class="col-sm-2">
            <a class="btn btn-success" href="{{ route('chucvu.create') }}">THÊM CHỨC VỤ MỚI</a>
          </div>
          <div class="col-sm-2">
                ...
                <table class="table table-hover text-nowrap">
                  ...
                  <tbody>
                    ...
                    <tr>
                      ...
                      <td>
                        <a class="btn btn-info" href="{{ route('chucvu.show',$chucvus->id) }}">Show</a>
                        {{-- <a class="btn btn-primary" href="{{ route('chucvu.edit',$chucvus->id_theloai) }}">Edit</a> --}}
                            {!! Form::open(['method' => 'DELETE','route' => ['chucvu.destroy', $chucvus->id],'style'=>'display:inline']) !!}
