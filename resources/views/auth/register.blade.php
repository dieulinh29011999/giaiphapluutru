  ...
  <div class="card">
    <div class="card-body register-card-body">
      ...
      <form method="POST" action="{{ route('register') }}">
        ...
        <input id="tenuser" type="text" class="form-control @error('tenuser') is-invalid @enderror" name="tenuser" value="{{ old('tenuser') }}" required autocomplete="name" autofocus placeholder="Enter username">
            @error('tenuser')
