...
@section('content')
  <section class="content-header">
    <div class="container-fluid">
      <div class="row mb-2">
        ...
        <div class="col-sm-2">
          @can('hospital-create')
          <a class="btn btn-success" href="{{route('benhvien.create')}}" accesskey="c"> Create New Hospital</a>
          @endcan
        </div>
        <div class="col-sm-4">
          <nav aria-label="breadcrumb ">
            <ol class="breadcrumb pink lighten-2 float-sm-right">
              ...
              <li class="breadcrumb-item"><i class="far fa-star mx-2 white-text" aria-hidden="true"></i><a
                  class="white-text" href="{{route('benhvien.index')}}">Hospital</a></li>
              <li class="breadcrumb-item active"><i class="far fa-star mx-2 white-text" aria-hidden="true"></i>Hospital Table</li>
            </ol>
          </nav>
        </div>
      </div>
  ...
  <div class="col-12">
    <div class="card-tools mb-2">
      <form action="{{route('benhvien.index')}}" class="form-inline d-flex justify-content-center md-form form-sm" method="GET" role="search">
          ...
          <table class="table table-bordered" style="text-align: center">
            <thead class="table-dark" style="text-align: center">
              ...
              <tbody>
                ...
                @can('hospital-edit','hospital-delete')
                <td>
                    <a href="{{ route('benhvien.edit',$value->id) }}"><i class="fas fa-edit mr-3"></i></a>
